...
def parse_args():
    ...
    # experiment folder dir
    parser.add_argument(
        '--dataset', type=str, default='r2r', 
        choices=['r2r', 'r4r', 'r2r_back', 'r2r_last', 'rxr']
    )
    # intervention experiment added options
    parser.add_argument('--ablate_names', nargs='*', default=None, help='enter a list of ablation datasets')
    parser.add_argument('--test_type', type=str, choices=['type1', 'type2'], default='', help=
    'type1 is full instruction no teacher forcing, type2 is parital instructions and with teacher forcing to certain viewpoint,'
    ...
    parser.add_argument('--eval_train', default=False,action='store_true', help="this option help simulate ground truth train data and obtain heading change at each step")
    parser.add_argument('--experiment_folder', type=str, default='', help='the specific data used for an experiment')
    parser.add_argument('--use_cfg_dir', default=False,action='store_true')
...
def postprocess_args(args):
    ...
    #     args.anno_dir = os.path.join(args.anno_dir, args.experiment_folder)
