...
from utils.direction_utils import (
    ...
    bootstrap_sample,
    draw_dists_with_confidence_tri,
...
if __name__ == "__main__":
    ...
    args.add_argument(
        ...
        type=str,
        default="stop/data",
        help="other options are 'results/envdrop-imagenet' and 'results/envdrop-imagenet",
    )
    ...
    args.add_argument(
        ...
        help="this is the root of your save directory",
    )
    ...
    draw_dists_with_confidence_tri(
        ...
        with_end_boot,
        ahead_partial_boot,
        name1="Implicit Stop Instruction",
        name2="Explicit Stop Instruction",
        name3="One-step Ahead Prior",
        ax=ax,
        curve=False,
        xlabel="Trajectory Length",
        ylabel="Average Stop Probability",
        savedir=f"./{save_dir}/stop.pdf",
    )
